...
[oc2ls-v1.1-lang.jadn](Schemas/OpenC2/JADN/oc2ls-v2.0-lang.jadn),
2. Common types
...
[oc2ls-v1.1-types.jadn](Schemas/OpenC2/JADN/oc2ls-v2.0-types.jadn).
...
* Create a base schema for the device, starting with the [device template](Schemas/OpenC2/JADN/oc2ls-v2.0-lang.jadn)
