...
[oc2ls-v1.1-lang.jadn](Projects/OpenC2/JADN/oc2ls-v2.0-lang.jadn),
2. Common types
...
[oc2ls-v1.1-types.jadn](Projects/OpenC2/JADN/oc2ls-v2.0-types.jadn).
...
* Create a base schema for the device, starting with the [device template](Projects/OpenC2/JADN/oc2ls-v2.0-lang.jadn)
* Resolve profile schemas into the [base schema](Projects/OpenC2-custom/device-pac-slpf-base.jadn)
to produce the [device schema](Projects/device-pac-slpf.jadn)
